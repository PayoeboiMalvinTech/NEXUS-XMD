...
const config = {
  SESSION_ID: process.env.SESSION_ID || "Joel-Md&Jqv6BMGD",
  ...
  STATUS_READ_MSG: process.env.STATUS_READ_MSG || 'Status Viewed by Nexus-Xmd',
  ...
  SUDO_NUMBERS: process.env.SUDO_NUMBERS || "263780166288,263780934873,263714757857",
